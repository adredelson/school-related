...
/*
* Description: This method removes the thread with id thread_id from this list. Should only be
* called if the thread with the given id is sleeping
*/
void SleepingThreadsList::remove(int thread_id) {
